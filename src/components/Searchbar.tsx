    ...
    <div className="nav-search-div">
      <div className="nav-search-div-two">
        <div className="search-svg-div">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="20" height="20">
            <path d="m14 14-2.867-2.867m1.534-3.8A5.333 5.333 0 1 1 2 7.333a5.333 5.333 0 0 1 10.667 0Z" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" fill="none"></path>
          </svg>
        </div>
      ...
      {debouncedSearchTerm && showResults && (
        <div className="search-results-container" ref={searchRef}>
          ...
          {searchResults.length === 0 && !error && showResults && <div className="no-search-result">No stocks found</div>}

          {error && <div className="no-search-result">{error}</div>}
        </div>
      )}
    </div>
  )
