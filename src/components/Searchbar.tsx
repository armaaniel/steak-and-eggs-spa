      ...
      <div className="nav-search-div-two">
        <div className="search-svg-div">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="20" height="20">
            <path d="m14 14-2.867-2.867m1.534-3.8A5.333 5.333 0 1 1 2 7.333a5.333 5.333 0 0 1 10.667 0Z" stroke="#32302F" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" fill="none"></path>
          </svg>
        </div>
