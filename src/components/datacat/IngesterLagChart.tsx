    ...
    <div className="ing-chart">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={series} margin={{ top: 4, right: 8, bottom: 0, left: 0 }}>
          ...
          <Line type="monotone" dataKey="maxExcessMs" name="worst excess (ms)" stroke="var(--dc-series-1)" strokeWidth={2} dot={false} />
          <Line type="monotone" dataKey="meanExcessMs" name="mean excess (ms)" stroke="var(--dc-series-2)" strokeWidth={2} dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )
